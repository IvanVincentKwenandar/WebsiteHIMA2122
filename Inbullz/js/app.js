const Navbar = () => {
    var urlTarget = ["/../../coming-soon.html", "https://drive.google.com/folderview?id=1xaCQl-XPIVwc79FPBrbCv9y8YEOZ0voD", "/../../index.html"]
    return (`<header>
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="${urlTarget[2]}">
                ...
                <div class="my-3 collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 textCenter-mobile">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="${urlTarget[2]}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${urlTarget[0]}">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${urlTarget[0]}">Event</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Inbullz</a>
                        </li>
                        <li class="nav-item">
